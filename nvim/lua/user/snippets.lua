...
ls.add_snippets("tex", {
  ...
  --bisschen versuche mit fold
  --s("limil", c(1, {
  	--t("\lim_{h \to 0}"),
  	--i(nil, "\lim_{h \to \infty}"),
  	--f(function(args) return "letzte option" end, {})
  --}))
  ...
  s("dr", {
    t("\\frac{d"), i(1), t("}{"), t("dx}"), t("\\left["), i(2), t("\\right]"), i(3),
  }),
