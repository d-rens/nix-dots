...
dashboard.section.buttons.val = {
 ...
 --  dashboard.button("q", " " .. " Quit", ":qa<CR>"),
  ...
  --dashboard.button("p", ">find project", ":lua require('telescope').extensions.projects.projects()<CR>"),
  dashboard.button("r", ">recent files", ":Telescope oldfiles <CR>"),
  dashboard.button("m", ">maths", ":e ~/documents/docs/LaTeX/notes/maths.tex <CR>"),
  dashboard.button("p", ">physics", ":e ~/documents/docs/LaTeX/notes/physic-l.tex <CR>"),
  dashboard.button("b", ">bspwm config", ":e ~/.config/bspwm/bspwmrc <CR>"),
  dashboard.button("s", ">sxdh? config", ":e ~/.config/sxhkd/sxhkdrc <CR>"),
