...
_G.packer_plugins = {
  ...
  ["hardtime.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/hardtime.nvim",
  ...
  ["obsidian.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/obsidian.nvim",
  ...
  tokyonight = {
    ...
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/tokyonight",
    url = "https://github.com/folke/tokyonight.nvim"
  },
  ultisnips = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/ultisnips",
