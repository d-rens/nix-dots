...
_G.packer_plugins = {
  ...
  ["competitest.nvim"] = {
    ...
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/competitest.nvim",
  ...
  ["kotlin-vim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/kotlin-vim",
  ...
  ["neoscroll.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/neoscroll.nvim",
  ...
  ["pandoc.nvim"] = {
    ...
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/pandoc.nvim",
  ...
  pywal = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/pywal",
  ...
  ["vim-startuptime"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/vim-startuptime",
